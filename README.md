...
Use the following buttons to deploy to your favourite hosting provider in one click! We support Vercel, Heroku, Netlify and DigitalOcean. You will need to enter the environment variables above when prompted.
